                                ...
                                <div class="row rentalForm">
                                    ...
                                    <div class="form-group col-md-4 col-lg-4">
                                        <div class="input-icon right ">
                                            <label>Units</label>
                                            {!! Form::select('unit',$units,$record->unit_id,array('placeholder'=> "","class"=>"form-control","id"=>"unit")) !!}
                                    ...
                                    <div class="form-group col-md-4 col-lg-4">
                                        <div class="input-icon input-icon-lg right">
                                            ...
                                            {!! Form::text('resident',$record->resident,array('placeholder'=>"","class"=>"form-control" )) !!}
                                    ...
                                    <div class="form-group col-md-4 col-lg-4">
                                        <div class="input-icon input-icon-lg right">
                                            ...
                                            {!! Form::text('contact',$record->contact,array('placeholder'=>"","class"=>"form-control" )) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4 col-lg-4">
                                        <div class="input-icon input-icon-lg right">
                                            <label >Vendor</label>
                                            {!! Form::select('vendor',$vendors,$record->vendor_id,array('placeholder'=> "","class"=>"form-control","id"=>"unit")) !!}
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4 col-lg-4">
                                        <div class="input-icon input-icon-lg right">
                                            ...
                                            {!! Form::select('entry',array(
                                                1 => 'YES',
                                                0 => 'NO'
                                            ),$record->entry,array('placeholder'=> "Entry","class"=>"form-control","id"=>"unit")) !!}
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4 col-lg-4">
                                        <div class="input-icon input-icon-lg right">
                                    ...
                                    <div class="form-group col-md-12 col-lg-12">
                                        <div class="input-icon input-icon-lg right">
                                            ...
                                            {!! Form::text('address',$record->address,array('placeholder'=>"","class"=>"form-control" )) !!}
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4 col-lg-4">
                                        <div class="input-icon right">
                                            ...
                                            {!! Form::select('type',array(
                                                        ...
                                                        'Violation' => 'Violation',
                                                        'Other' => 'Other'
                                            ),$record->type,array('placeholder'=> "","class"=>"form-control","id"=>"Unit")) !!}
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4 col-lg-4">
                                        <div class="input-icon right">
                                    ...
                                    <div class="form-group col-md-4 col-lg-4">
                                        <div class="input-icon right">
                                            ...
                                            {!! Form::select('priority',array(
                                                        ...
                                                        'High' => 'High',
                                                        'Urgent' => 'Urgent'
                                          ),$record->priority,array('placeholder'=> "","class"=>"form-control","id"=>"priority")) !!}
                                        </div>
                                    </div>
                                      ...
                                      <i class="fa fa-calendar"></i>
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            ...
                                            <div class="input-group  date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
                                                ...
                                                {!! Form::text('due_date',$record->due_date,array('placeholder'=>"","class"=>"form-control",'readonly'=>'readonly' )) !!}
                                                <span class="input-group-btn">
                                       <button class="btn default" type="button">
                                          <i class="fa fa-calendar"></i>
                                       </button>
