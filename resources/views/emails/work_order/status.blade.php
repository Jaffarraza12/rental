                            ...
                            <table border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth" width="400" style="margin: 0 auto;" >
                                ...
                                <tr>
                                    <td style="text-align: center;" class="center">
                                        <a class="headline"  style="margin-bottom:5px;text-decoration: none; font-size: 32px;color: #49196f;font-family: Verdana, Geneva, sans-serif;">Work Order Status Update  <br/> </a>
                                        <a class="headline" style="margin-bottom:5px;text-decoration: none; font-size: 22px;color: #49196f;font-family: Verdana, Geneva, sans-serif;">Work Order Status Changed To {{$WO->status}} of Unit# {{$unit->name}}</a>
                                        <a class="headline" style="margin-bottom:5px;text-decoration: none; font-size: 22px;color: #49196f;font-family: Verdana, Geneva, sans-serif;">Work Order Assign to {{$user->name }} </a>
                                        <a class="headline"  style="margin-bottom:5px;text-decoration: none; font-size: 22px;color: #49196f;font-family: Verdana, Geneva, sans-serif;"> </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: center;" class="center" >
