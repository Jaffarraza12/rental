                            ...
                            <div class="portlet light bordered">
                                <div class="col">
                                    <div class="caption"><h1>{{$heading. ' ' }}</h1>
                                        ...
                                        <span> <a class="btn btn-redish" href="http://localhost/rental/lease"><small><icon class="fa fa-plus"></icon><span>  ADD LEASE</span></small></a></span>    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body flip-scroll">
                                    ...
                                    <table id="attribute" class="table table-striped table-bordered table-hover dt-responsive dataTable no-footer dtr-inline collapsed">
                                        ...
                                        <tr>
                                            <th class="filter-input" data-id="dsa" data-placeholder="Name">Lease </th>
                                            <th class="filter-input" data-placeholder="Contact">Type</th>
                                            <th class="" width="100">Days Left </th>
                                            <th class="" width="100">Rent</th>
                                            <th >Status</th>
                                            <th class="numeric">  </th>
                                        </tr>
                                        </thead>
