        ...
        <div class="form-body">
            ...
            <div class="form-group col-md-6 col-lg-6">
                <div class="input-icon input-icon-lg right">
                    ...
                    {!! Form::text('unit',null,array('placeholder'=> "","class"=>"form-control","id"=>"unit_show" )) !!}
        ...
        <div class="col-md-12 col-lg-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <div class="col-md-4 col-lg-4" >
                        <div class="input-group  date-picker input-daterange" data-date="10/11/2012" data-date-format="mm/dd/yyyy">
                            {!! Form::select('rent_duration',array(
                                '12' => '12 Months',
                                '8' => '8 Months',
                                '6' => '6 Months',
                                '4' => '4 Months',
                                ),'12',array('placeholder'=> "Payment Tem","class"=>"form-control","id"=>'lease_prefer' )) !!}
                        </div>
                        <!-- /input-group -->
                    </div>

                    <div class="col-md-6 col-lg-6 date_range" style="display: none;">
                        <div class="input-group  date-picker input-daterange" data-date="10/11/2012" data-date-format="mm/dd/yyyy">
                    ...
                    <div class="col-md-6 col-lg-6 single_date" style="display: none;">
                        <div class="input-group  date-picker input-daterange" data-date="10/11/2012" data-date-format="mm/dd/yyyy">
                            {!! Form::hidden('starting_date',date('d/m/Y'),null,array("class"=>"form-control" )) !!}
                            {!! Form::text('ending_date',null,array("class"=>"form-control" )) !!}
                        </div>
                        <!-- /input-group -->
                    </div>
                    <div class="clearfix"></div>
