        ...
        <div class="row rentalForm">
            ...
            <div class="form-group col-md-4 col-lg-4">
                <div class="input-icon input-icon-lg right">
                    <label >Tenant</label>
                    {!! Form::select('tenant_id',$tenants,old('tenant_id'),array('placeholder'=> "","class"=>"form-control","id"=>"tenant")) !!}
                </div>
            </div>
            ...
            <div class="form-group col-md-4 col-lg-4">
                <div class="input-icon right">
                    ...
                    {!! Form::select('category',array(
                                ...
                                'Other' => 'Other',
                  ),old('category'),array('placeholder'=> "","class"=>"form-control","id"=>"priority")) !!}
                </div>
            </div>
            <div class="form-group col-md-4 col-lg-4">
                <div class="input-icon input-icon-lg right">
            ...
            <div class="col-md-4 col-lg-4">
                ...
                <div class="input-group  date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
                    ...
                    {!! Form::text('due',old('due'),array('placeholder'=>"","class"=>"form-control",'readonly'=>'readonly' )) !!}
            ...
            <div class="form-group col-md-4 col-lg-4">
                <div class="input-icon right">
                    ...
                    {!! Form::select('priorty',array(
                                ...
                                '1' => 'Medium',
                                '2' => 'High',
                  ),old('priorty'),array('placeholder'=> "","class"=>"form-control","id"=>"priority")) !!}
                </div>
            </div>
            <div class="clearfix"></div>
