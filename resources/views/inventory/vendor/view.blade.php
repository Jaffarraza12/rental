                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                <div class="col">
                                    <div class="caption">
                                        <h1> {{$heading. ' ' }}</h1> <span> <a class="btn btn-redish" href="{{ URL('vendors/create') }}" ><small><icon class="fa fa-plus"></icon><span>  ADD VENDOR</span></small></a></span>
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body flip-scroll">
                                    ...
                                    <table id="attribute" class="table table-striped table-bordered table-hover dt-responsive dataTable no-footer dtr-inline collapsed">
                                        ...
                                        <tr>
                                            ...
                                            <th class="filter-input" data-placeholder="Phone">Company </th>
                                            <th class="filter-select-index" data-placeholder="Status">Email</th>
                                            <th class="filter-select-index" data-placeholder="Status">Phone</th>
                                            <th class="numeric">  </th>
                                        </tr>
                                        </thead>
                                        <tfoot>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var table = $('#attribute').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! URL('/vendors/data') !!}',
            columns: [
                { data: 'name', name: 'name', bSortable: false },
                { data: 'contact_email', name: 'contact_email', bSortable: false },
                { data: 'phone_mobile', name: 'phone_mobile', bSortable: false },
                { data: 'operations', name: 'operations', searchable: false, bSortable: false }
                ...
                this.api().columns('.filter-input' ).every( function (i) {
                    var column = this;
                    var title = $(this).text();
                    /*var title = $(column).attr('data-placeholder');*/
        ...
        $("body").on("click",".remove",function () {
            ...
            if(sure) {
                url = app.baseUrl()+'/vendors/'+$(this).data("id")
