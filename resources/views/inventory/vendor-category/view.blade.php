                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                <div class="col">
                                    <div class="caption">
                                        <h1> {{$heading. ' ' }}</h1> <span> <a class="btn btn-redish" href="{{ URL('vendors-category/create') }}" ><small><icon class="fa fa-plus"></icon><span>  ADD CATEGORY</span></small></a></span>
                                    </div>
                                    <div class="tools">
...
<script>
    ...
    $(document).ready(function(){
        ...
        var table = $('#attribute').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! URL('vendors-category/data') !!}',
            columns: [
                { data: 'name', name: 'name'},
                { data: 'detail', name: 'detail', bSortable: false },
        ...
        $("body").on("click",".remove",function () {
            ...
            if(sure) {
                url = app.baseUrl()+'/vendors-category/'+$(this).data("id")
