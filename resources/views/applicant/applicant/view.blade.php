                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption"><i style="margin-top:2px;" class="icon-user">  </i> {{$heading. ' ' }}<br/><br/>
                                        ...
                                        <span> <a class="btn btn-redish" href="{{URL('applicant/add/')}}" ><small><icon class="fa fa-plus"></icon><span>  ADD APPLICANT</span></small></a></span>
                                        <span> <a class="btn btn-blackish pop" data-url="{{URL('lease')}}" ><small><icon class="fa fa-money"></icon><span>  ADD LEASE AGREEMENT</span></small></a></span>
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body flip-scroll">
                                    ...
                                    <table id="attribute" class="table table-striped table-bordered table-hover dt-responsive dataTable no-footer dtr-inline collapsed">
                                        ...
                                        <tr>
                                            ...
                                            <th class="filter-select-index" >Prefer type</th>
                                            <th >Address</th>
