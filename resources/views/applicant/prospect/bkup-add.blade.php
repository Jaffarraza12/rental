                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div id="general" >
                                                            ...
                                                            <div class="form-group col-md-6 col-lg-6">
                                                                <div class="input-icon input-icon-lg right">
                                                                    <label>Mobile</label>
                                                                    {!! Form::text('mobile',old('address'),array("class"=>"form-control" )) !!}
                                                                </div>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                            ...
                                                            <div class="form-group col-md-6 col-lg-6">
                                                                <div class="input-icon right">
                                                                    ...
                                                                    {!! Form::select('unit_prefer', array(
                                                                            ...
                                                                            '2 Bedroom' => '2 Bedroom',
                                                                            '3 Bedroom' => '3 Bedroom'
                                                                            ),old('unit_prefer'),array("class"=>"form-control","id"=>"type" )) !!}
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-md-6 col-lg-6">
                                                                <div class="input-icon input-icon-lg right">
                                                                    <label>Unit no (optional)</label>
                                                                    {!! Form::text('unit_id',old('unit_id'),array("class"=>"form-control" )) !!}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div  class="form-group col-md-12 col-lg-12" style="margin-left: 15px;margin-top: 10px;">
                                                            ...
                                                            {!! Form::submit( 'Save And Email Rental Applicantion', ['class' => 'btn red btn', 'name' => 'save', 'value' => 'continue']) !!}
                                                        </div>
                                                        </div>
