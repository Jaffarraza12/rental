                            ...
                            <div class="portlet light bordered">
                                <div class="col">
                                    <div class="caption"><h1> {{$heading. ' ' }}</h1>
                                                                             <span> <a class="btn btn-redish" href="{{ URL('applicants/create') }}" ><small><icon class="fa fa-plus"></icon><span>  ADD APPLICANT</span></small></a></span>
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body flip-scroll">
                                    ...
                                    <table id="attribute" class="table table-striped table-bordered table-hover dt-responsive dataTable no-footer dtr-inline collapsed">
                                        ...
                                        <tr>
                                            ...
                                            <th class="filter-select-index" data-placeholder="Status">Status</th>
                                            <th class="numeric">  </th>
                                        </tr>
                                        </thead>
                                        <tfoot>
