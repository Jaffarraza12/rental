                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="tools">
                                        <div class="dt-buttons pull-right">
                                            <div class="btn-group">
                                                <button class="btn red btn" type="submit"><i class="fa fa-save do_post"></i> Save</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="tab-content attribute_per_group">
                                                            ...
                                                            <div class="tab-pane fade in active" id="general" >
                                                                <div class="form-group col-md-6 col-lg-6">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        ...
                                                                        {!! Form::text('name',$tenant->name,array('placeholder'=>"Full Name","class"=>"form-control" )) !!}
                                                                    </div>
                                                                </div>
                                                                <div class="form-group col-md-6 col-lg-6">
                                                                    <div class="input-icon  input-icon-lg  right">
                                                                        <i class="fa fa-envelope"></i>
                                                                        {!! Form::text('email',$tenant->email,array('placeholder'=>"Email","class"=>"form-control" )) !!}
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-4 col-lg-4">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        ...
                                                                        {!! Form::text('phone',$tenant->phone,array('placeholder'=>"Phone","class"=>"form-control" )) !!}
                                                                    </div>
                                                                </div>
                                                                <div class="form-group col-md-4 col-lg-4">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        <i class="fa fa-phone"></i>
                                                                        {!! Form::text('ssn',$tenant->ssn,array('placeholder'=>"Social Security Number","class"=>"form-control" )) !!}
                                                                    </div>
                                                                </div>
                                                                <div class="form-group col-md-4 col-lg-4">
                                                                    <div class="input-icon right">
                                                                        ...
                                                                        ),$tenant->payment_type,array('placeholder'=>"Payment Type","class"=>"form-control" )) !!}
                                                                    </div>
                                                                </div>
                                                                <div class="clearfix"></div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        ...
                                                                        {!! Form::textarea('address',$tenant->address,array('placeholder'=>"Address","class"=>"form-control" )) !!}
                                                                    </div>
                                                                </div>
                                                                <div class="clearfix"></div>
                                                            ...
                                                            <div class="tab-pane fade" id="lease">
                                                                <div class="form-group col-md-6 col-lg-6">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        ...
                                                                        {!! Form::select('building_id',$buildings,$lease->buidling_id,array('placeholder'=> "Building","class"=>"form-control","id"=>"building" )) !!}
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-6 col-lg-6">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        ...
                                                                        {!! Form::hidden('unit_id',$lease->unit_id,array('id'=>'unit_id')) !!}
                                                                        {!! Form::text('unit',$lease->UNIT,array('placeholder'=> "Unit Name","class"=>"form-control","id"=>"unit_show" )) !!}
                                                                ...
                                                                <div class="portlet light bordered">
                                                                    ...
                                                                    <div class="portlet-body">
                                                                        <div class="form-group col-md-6  col-lg-6">
                                                                            <div class="input-icon input-icon-lg right">
                                                                                ...
                                                                                {!! Form::select('lease_prefer',array(
                                                                                    ...
                                                                                    'Yearly' => 'Yearly'
                                                                                    ),$lease->lease_prefer,array('placeholder'=> "Payment Tem","class"=>"form-control","id"=>'lease_prefer' )) !!}
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-lg-6 date_range">
                                                                            <div class="input-group  date-picker input-daterange" data-date="10/11/2012" data-date-format="mm/dd/yyyy">
                                                                                {!! Form::text('from',$lease->date_start,array("class"=>"form-control" )) !!}
                                                                                <span class="input-group-addon"> to </span>
                                                                                {!! Form::text('to',$lease->date_end,array("class"=>"form-control" )) !!}
                                                                            </div>
                                                                            <!-- /input-group -->
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 col-lg-6 single_date" style="display: none;">
                                                                            <div class="input-group  date-picker input-daterange" data-date="10/11/2012" data-date-format="mm/dd/yyyy">
                                                                                {!! Form::text('starting_date',$lease->date_start,array("class"=>"form-control" )) !!}
                                                                            </div>
                                                                            <!-- /input-group -->
                                                                        </div>
                                                                        <div class="clearfix"></div>
                                                                        <div class="form-group col-md-4  col-lg-4">
                                                                            <div class="input-icon input-icon-lg right">
                                                                                ...
                                                                                {!! Form::select('notice_period',array(
                                                                                    ...
                                                                                    '60 days' => '60 days',
                                                                                    '90 days' => '90 days'
                                                                                    ),$lease->notice_period,array('placeholder'=> "Notice Period ","class"=>"form-control" )) !!}
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group col-md-4 col-md-4">
                                                                            <div class="input-icon right">
                                                                                <i class="fa fa-dollar"></i>
                                                                                {!! Form::text('rate',$lease->rate,array('placeholder'=> "Rent","class"=>"form-control" )) !!}
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group col-md-4 col-md-4">
                                                                            <div class="input-icon right">
                                                                                <i class="fa fa-summary"></i>
                                                                                {!! Form::text('comment',$lease->comment,array('placeholder'=> "Comments","class"=>"form-control" )) !!}
                                                                            </div>
                                                                        </div>
                                                                        <div class="clearfix"></div>
                                                                    </div>
                                                            ...
                                                            <div class="tab-pane fade" id="detail">
                                                                <div class="form-group">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        <i class="fa fa-car"></i>
                                                                        {!! Form::text('driving_license',$tenant->driving_license,array('placeholder'=>"Driving License","class"=>"form-control" )) !!}
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        ...
                                                                        {!! Form::select('smoke',array(
                                                                            'Yes' => 'Yes',
                                                                            'No' => 'No'
                                                                            ),$tenant->smoke,array('placeholder'=>"Somking ","class"=>"form-control icheck" )) !!}
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        ...
                                                                        {!! Form::select('profile',array(
                                                                            ...
                                                                            'Other' => 'Other'
                                                                            ),$tenant->profile,array('placeholder'=> "Profile","class"=>"form-control" )) !!}
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        ...
                                                                        {!! Form::select('lease_perfer',array(
                                                                            ...
                                                                            'Yearly' => 'Yearly'
                                                                            ),$tenant->lease_perfer,array('placeholder'=> "Lease Preference","class"=>"form-control" )) !!}
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        <i class="fa fa-user"></i>
                                                                        {!! Form::textarea('notes',$tenant->notes,array('placeholder'=>"Notes","class"=>"form-control" )) !!}
                                                                    </div>
                                                                </div>
