                                                            ...
                                                            <div class="tab-pane fade" id="lease">
                                                                <div class="form-group col-md-6 col-lg-6">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        ...
                                                                        {!! Form::text('building_id',$buildings->name,array('placeholder'=> "Building","class"=>"form-control","id"=>"building" )) !!}
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-6 col-lg-6">
                                                                    <div class="input-icon input-icon-lg right">
                                                                        ...
                                                                        {!! Form::select('unit',$unit,null,array('placeholder'=> "Unit Name","class"=>"form-control","id"=>"unit_show" )) !!}
