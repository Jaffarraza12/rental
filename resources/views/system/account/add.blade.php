                                                ...
                                                <div class="">
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="form-group col-md-4 col-lg-4">
                                                            <div class="input-icon input-icon-lg right">
                                                                <label>type</label>
                                                                {!! Form::select('pid',$types,0,array('placeholder'=>"","class"=>"form-control")) !!}
                                                        ...
                                                        <div class="form-group col-md-4 col-lg-4">
                                                            <div class="input-icon input-icon-lg right">
                                                                ...
                                                                {!! Form::select('sub',array(),0,array('placeholder'=>"","class"=>"form-control")) !!}
                                                        ...
                                                        <div class="form-group col-md-12 col-lg-12">
                                                            <div class="input-icon input-icon-lg right">
                                                                <label>Comment</label>
                                                                {!! Form::textarea('comment',old('detail'),array("class"=>"form-control" )) !!}
