                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                <div class="col">
                                    <div class="caption">
                                        <h1> {{$heading. ' ' }}</h1> <span> <a class="btn btn-redish" href="{{ URL('account/create') }}" ><small><icon class="fa fa-plus"></icon><span>  ADD ACCOUNT</span></small></a></span>
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body flip-scroll">
                                    ...
                                    <table id="attribute" class="table table-striped table-bordered table-hover dt-responsive dataTable no-footer dtr-inline collapsed">
                                        ...
                                        <tr>
                                            ...
                                            <th class="filter-select-value" data-placeholder="Status">Type </th>
                                            <th >Sub </th>
                                            <th class="numeric">  </th>
                                        </tr>
                                        </thead>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var table = $('#attribute').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! URL('account/data') !!}',
            columns: [
                { data: 'name', name: 'name'},
                { data: 'type', name: 'type', bSortable: false },
                { data: 'sub', name: 'sub', bSortable: false },
        ...
        $("body").on("click",".remove",function () {
            ...
            if(sure) {
                url = app.baseUrl()+'/account/'+$(this).data("id")
