...
@section('content')
    ...
    <div class="portlet-body form">
        {!! Form::open(array('url' => URL('role/edit/'.$id) ,'method'=>'post')) !!}
        <div class="form-body">
            ...
            <div class="form-group">
                <div class="input-icon input-icon-lg right">
                    <i class="fa fa-text-width"></i>
                    {!! Form::text('display_name',$role->display_name,array('placeholder'=>"Diplay Name","class"=>"form-control" )) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="input-icon input-icon-lg right">
                    ...
                    {!! Form::textarea('description',$role->description,array('placeholder'=>"Description","class"=>"form-control" )) !!}
                </div>
            </div>
            <div class="form-group">
                <div class="input-icon input-icon-lg right">
