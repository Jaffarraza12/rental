        ...
        <div class="form-body">
            ...
            <div class="form-group col-md-4 col-lg-4">
              <div class="input-icon input-icon-lg right">
                  ...
                  {!! Form::text('name',old('name'),array('placeholder'=>"Summary","class"=>"form-control" )) !!}
              </div>
            </div>
            <div class="form-group col-md-4 col-lg-4">
                <div class="input-icon right ">
                    <i class="fa fa-building-o for-select"></i>
                    {!! Form::select('building',$buildings,old('building'),array('placeholder'=> "Buildings","class"=>"form-control","id"=>"building")) !!}
                </div>
            </div>
            <div class="form-group col-md-4 col-lg-4">
                <div class="input-icon right ">
                    <i class="fa fa-square-o for-select"></i>
                    {!! Form::select('unit',array(),old('unit'),array('placeholder'=> "Units","class"=>"form-control","id"=>"unit")) !!}
                </div>
            </div>
            <div class="form-group col-md-4 col-lg-4">
                <div class="input-icon input-icon-lg right">
                    <i class="fa fa-user"></i>
                    {!! Form::text('resident',null,array('placeholder'=>"Resident Name","class"=>"form-control" )) !!}
                </div>
            </div>
            ...
            <div class="form-group col-md-4 col-lg-4">
                <div class="input-icon input-icon-lg right">
                    ...
                    {!! Form::text('address',null,array('placeholder'=>"Building Address","class"=>"form-control" )) !!}
                </div>
            </div>
            <div class="form-group col-md-4 col-lg-4">
                <div class="input-icon right">
                    ...
                    {!! Form::select('type',array(
                                ...
                                'Violation' => 'Violation',
                                'Other' => 'Other'
                    ),old('type'),array('placeholder'=> "Work Order Type","class"=>"form-control","id"=>"Unit")) !!}
                </div>
            </div>
            <div class="form-group col-md-4 col-lg-4">
                <div class="input-icon right">
                    ...
                    ),old('status'),array('placeholder'=> "Status","class"=>"form-control","id"=>"opened")) !!}
                </div>
            </div>
            <div class="form-group col-md-4 col-lg-4">
                <div class="input-icon right">
                    ...
                    {!! Form::select('priority',array(
                                ...
                                'High' => 'High',
                                'Urgent' => 'Urgent'
                  ),old('priority'),array('placeholder'=> "Priority","class"=>"form-control","id"=>"priority")) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                    <div class="col-md-6">
                        <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
                            {!! Form::text('date_opened',old('date_open'),array('placeholder'=>"Date Opened","class"=>"form-control",'readonly'=>'readonly' )) !!}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
                            {!! Form::text('due_date',old('due_date'),array('placeholder'=>"Due Date","class"=>"form-control",'readonly'=>'readonly' )) !!}
                            <span class="input-group-btn">
                                       <button class="btn default" type="button">
                                          <i class="fa fa-calendar"></i>
                                       </button>
