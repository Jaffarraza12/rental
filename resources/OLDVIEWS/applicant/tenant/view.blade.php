                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption"><i style="margin-top:2px;" class="icon-user">  </i> {{$heading. ' ' }}<br/><br/>
                                        ...
                                        <span> <a class="btn btn-sm red btn-outline" href="{{URL('tenant/add/')}}" ><small><icon class="fa fa-plus"></icon><span>  ADD TENANT</span></small></a></span>    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body flip-scroll">
                                    <table id="attribute" class="table table-striped table-bordered table-hover dt-responsive dataTable no-footer dtr-inline collapsed">
                                        ...
                                        <tr>
                                            ...
                                            <th class="filter-input">Building</th>
                                            <th class="filter-input">Unit</th>
                                            <th class="filter-input">Payment</th>
    ...
    $(document).ready(function(){
        ...
        var table = $('#attribute').DataTable({
            ...
            columns: [
                ...
                { data: 'BUILDING', name: 'BUILDING', bSortable: false },
